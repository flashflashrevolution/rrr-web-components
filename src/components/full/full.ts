...
export class FullElement extends TwLitElement {
  ...
  protected render(): TemplateResult {
    return html`
            <div class="select-none relative mx-auto flex max-h-rrr min-h-rrr min-w-rrr max-w-rrr gap-x-2">
                <slot class="absolute flex h-full w-full z-0" name="background">Error: Background should appear here.</slot>
